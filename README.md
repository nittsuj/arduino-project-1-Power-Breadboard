...
## materials
- Breadboard <img src="img/breadboard.jpg" alt="Breadboard" width="200">

- LED <img src="img/red_LED.jpg" alt="LED" width="200">

- Battery Adapter <img src="img/battery_adapter.jpg" alt="Battery Adapter" width="200">

- Resistor <img src="img/resistor.jpg" alt="Resistor" width="200">

- Solderless Jumper Wire <img src="img/solderless_jumper_wire.jpg" alt="Solderless Jumper Wire" width="200">
